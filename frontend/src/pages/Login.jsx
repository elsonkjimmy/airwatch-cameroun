        ...
        {!selectedPortail ? (
          ...
          <div className="glass-card rounded-[44px] p-10 lg:p-14 border-white/10 space-y-10 relative overflow-hidden animate-in zoom-in-95 duration-500 mx-auto">
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              <div className="space-y-2"><label className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-500 ml-4">Identifiant</label><input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-white/5 border border-white/5 rounded-3xl px-8 py-5 text-sm text-white focus:outline-none focus:border-[#81d4d8]/50 focus:bg-white/10 transition-all font-bold placeholder:text-slate-800" placeholder="nom@airwatch.cm" /></div>
              <div className="space-y-2"><label className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-500 ml-4">Code Secret</label><input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full bg-white/5 border border-white/5 rounded-3xl px-8 py-5 text-sm text-white focus:outline-none focus:border-[#81d4d8]/50 focus:bg-white/10 transition-all font-bold placeholder:text-slate-800" placeholder="••••••••" /></div>
