...
const returnStart = code.indexOf(returnMatch, dashboardStart);

if (returnStart === -1) throw new Error("Could not find return match!");

const prefix = code.substring(0, returnStart);
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 shadow-sm">
        ...
        <div className="p-4 bg-gradient-to-b from-slate-900 to-slate-800 text-white">
          ...
          <p className="text-slate-400 text-xs">Surveillance purifiée de l'air</p>
        </div>
        ...
        <header className="sticky top-0 z-50 bg-slate-900 text-white px-6 py-3 flex items-center justify-between shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs leading-tight">Prévision qualité de l'air</p>
            </div>
          </div>
          ...
          >
            ...
            {firms.hasFireNearby && (
              <div className="mt-3 flex items-center gap-2 px-3 py-2 bg-red-50 border border-red-200 rounded-xl text-xs text-red-700">
                ...
                <span>NASA FIRMS : {firms.fireCount50km} feux confirmés à moins de 50km</span>
              </div>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl shadow-sm p-4 border border-gray-100">
              <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2 text-sm">
                <AlertTriangle className="text-red-500" size={16} /> Top 5 — Plus pollué
              </h3>
...
console.log("Dashboard.jsx fully repaired!");
